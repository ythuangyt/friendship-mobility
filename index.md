...
For those whose average check-in distance from home is less than 26 km, the more they travel, the less similar they are. Users travel less than 26 km should be traveling within the city they live and the adjacent cities. We infer that on a small distance scale where people basically move around to deal with their daily needs, the more they travel, the more types of location they will visit. This conclusion seems satisfying but it falls to explain the increasing similarity as people travel more. However, this phenomenon can be explained by the fact that users traveling very long distances will check-in at a hotel or a restaurant with high probability.
...
Do you ever feel that, you see a person at a certain place, say your yoga class, then keep on bumping into him or her at other unrelated places? Does that actually have any statistical sense? Focusing on **local** check-in behaviors in this question, we only look into the check-ins in one specific country. (We take US as our example, since check-in data amount in US are the most.) 
