...
Using this dataset we will analyze the effect of friendship and distance on a user's checkins location categories.
...
<iframe id='similarity_sociability_distribution' frameborder="no" border="0" marginwidth="0" marginheight="0" width="100%" height="550" src="plot/similarity_sociabilty_distribution.html"></iframe>
...
This can be explained by a few things: first of all traveling somewhat obligates a person to vary its visits: a Swiss citizen won't necessarly have many occasion to eat fondue if they travel a lot! People traveling a lot won't necessarly travel in the same places so it explains that their visits are different from one another. This explication seems satisfying but it cannot explain everything: indeed a group of people traveling an average of 5km will have a much higher similarity than a group who travels in average 50km (increase of 25%), even though the difference between both average distances is not that large (50km is still probably in the same city or in a neighbor one). It seems as there is a correlation between the will of users to travel more (even at low scale) and their will to vary their visits.
