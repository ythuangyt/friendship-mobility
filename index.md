...
Consider each user as a node in a graph, and edges represent the friendship between users. 2-edges friends of one user are those whose distance to that user are 2-edges in the graph. The same rule applies to 3-5 edges friends.
