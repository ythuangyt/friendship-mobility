...
For those whose average check-in distance from home being less than 26 km, the more they travel, the less similar they are. It is very likely that users travel less than 26 km are traveling within the city they live and the adjacent cities; hence, we infer that on a small distance scale, more check-ins will vary the location types. The similarity rises after 26 km. This phenomenon can be explained by the fact that users traveling longer distances are checking-in at a hotel or a restaurant with higher probability.
